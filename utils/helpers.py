...
# alias, refactoring this into `col` slowly, but such a short name = conflicts?
colorize = color
...
assert rewrite_trace_multiline(test_trace, test_f, 2) == [
    "a", "q", "w", "e", "d"]
...
def pretty_bignum(num):
    ...
    if num == 0x19457468657265756D205369676E6564204D6573736167653A0A333200000000:
        # common, todo correct parsing of RLP encoding
